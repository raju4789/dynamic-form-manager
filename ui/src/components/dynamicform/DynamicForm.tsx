...
import {
  PageContainer, LanguageDropdownContainer, LanguageDropdown, FormContainer, FormHeader,
...
const DynamicForm: React.FC = () => {
  ...
  const renderField = (field: IField) => {
    ...
    const placeholder = field.placeHolders.find((p) => p.languageId === language)?.placeHolderName || '';
    const errorMessage = field.fieldValidationErrorMessages.find((e) => e.languageId === language)
